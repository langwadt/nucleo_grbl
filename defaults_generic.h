...
#define defaults_h
  ...
  #define DEFAULT_X_STEPS_PER_MM 200.0*8
  #define DEFAULT_Y_STEPS_PER_MM 200.0*8
  #define DEFAULT_Z_STEPS_PER_MM 200.0*8
  ...
  #define DEFAULT_STATUS_REPORT_MASK ((BITFLAG_RT_STATUS_MACHINE_POSITION)|(BITFLAG_RT_STATUS_WORK_POSITION)|BITFLAG_RT_STATUS_LIMIT_PINS)
